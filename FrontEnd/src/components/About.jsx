                ...
                <div className="container my-5 py-5">
                    <div className='row'>
                        <div className='col-12'>
                            ...
                            <h1 className="lead text-center fs-4 mb-5 text-white">Um projeto desenvolvido por alunos da <span style={{ color: '#00ADFC' }}>UNB</span> com o intuito de ajudar os estudantes a descobrirem se foram aprovados pelo proceso seleetivo <span style={{ color: '#00E6CF' }}>PAS</span>.</h1>
                        </div>
                    </div>
